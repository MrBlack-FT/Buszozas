...
public class CustomInputFieldBackground : MonoBehaviour
{
    #region Változók
    ...
    private void Awake()
    {
        ...
        entryEnter.callback.AddListener((eventData) =>
        {
            ...
            //debugger.CustomDebugLog($"Selecting {gameObject.name} input field because PointerEnter event was triggered.");
